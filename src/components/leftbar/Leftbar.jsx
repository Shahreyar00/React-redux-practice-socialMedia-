...
import { ExitToAppOutlined, FileCopyOutlined, GroupOutlined, HearingOutlined, HomeOutlined, ListAlt, MovieCreationOutlined, PhotoSizeSelectActualOutlined, ScheduleOutlined, Settings, ShoppingBasketOutlined } from '@material-ui/icons'
    ...
    return (
        <div className="leftbar">
            <div className="leftbarWrapper">
                ...
                <MenuLink icon={<ListAlt />} text="Lists" />
